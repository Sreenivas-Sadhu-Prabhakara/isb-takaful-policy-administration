package com.bank.islamic.takafulpolicyadministration.model;
...
/**
 * The BIAN control record for this service domain: "Takaful Certificate Administrative Plan".
 *
 ...
 * to its asset type (Takaful Certificate). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Takaful Certificate Administrative Plan";
